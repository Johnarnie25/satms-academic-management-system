...
<div class="head-title">
    <div class="left">
        ...
        <ul class="breadcrumb">
            ...
            <li><a class="active">My Subjects</a></li>
        </ul>
    </div>
</div>
...
<a href="?page=<?= $i ?>&limit=<?= $limit ?>&filterYear=<?= urlencode($filterYear) ?>&filterSem=<?= urlencode($filterSem) ?>&search=<?= urlencode($search) ?>" class="btn small <?= $i==$page?'primary':'' ?>"><?= $i ?></a>
<?php } ?>
